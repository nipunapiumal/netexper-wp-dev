...
if (!function_exists('OvaFramework')) {
    ...
    class OvaFramework {
        ...
        function __construct() {
            ...
            add_filter( 'ova_share_social', array( $this, 'infetech_content_social' ), 2, 10 );
        ...
        public function infetech_content_social( $link, $title ) {
            $html = '<ul class="share-social">
                        <li>
                            <a class="share-ico ico-facebook" target="_blank" href="http://www.facebook.com/sharer.php?u='.$link.'" title="'.$title.'">
                                ...
                                '.esc_html__( 'Facebook','ova-framework' ).'
                            </a>
                        </li>
                        <li>
                            <a class="share-ico ico-twitter" target="_blank" href="https://twitter.com/share?url='.$link.'&amp;text=urlencode('.$title.')" title="'.$title.'">
                                <i class="fab fa-twitter"></i>
                                '.esc_html__( 'Twitter','ova-framework' ).'
                            </a>
                        </li>
                        <li>
                            <a class="share-ico ico-pinterest" target="_blank" href="https://pinterest.com/pin/create/button/?url='.$link.'" title="'.$title.'">
                                <i class="fab fa-pinterest"></i>
                                '.esc_html__( 'Pinterest','ova-framework' ).'
                            </a>
                        </li>               
                    </ul>';
