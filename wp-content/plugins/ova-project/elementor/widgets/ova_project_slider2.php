...
class ova_project_slider2 extends Widget_Base {

	public function get_name() {
		return 'ova_project_slider2';
	}

	public function get_title() {
		return esc_html__( 'Project Slider 2', 'ova-project' );
	}
		...
		$this->start_controls_section(
            ...
            $this->add_group_control(
				...
				[
					...
					'selector' 	=> '{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item .ova-media .content .title',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item .ova-media .content .title' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item:hover .ova-media .content .title' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_responsive_control(
	            ...
	            [
	                ...
	                'size_units' 	=> [ 'px', '%', 'em' ],
	                'selectors' 	=> [
	                    '{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item .ova-media .content .title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	                ],
	            ]
	        );
		...
		$this->start_controls_section(
            ...
            $this->add_group_control(
				...
				[
					...
					'selector' 	=> '{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item .ova-media .content .sub_title',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item .ova-media .content .sub_title' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item:hover .ova-media .content .sub_title' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_responsive_control(
	            ...
	            [
	                ...
	                'size_units' 	=> [ 'px', '%', 'em' ],
	                'selectors' 	=> [
	                    '{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item .ova-media .content .sub_title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	                ],
	            ]
	        );
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item .ova-media .icon i' => 'font-size: {{SIZE}}{{UNIT}};',
					],
				]
			);
				...
				$this->start_controls_tab(
		            ...
		            [
                     ...
                     $this->add_control(
						...
						[
							...
							'type' 		=> Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item .ova-media .icon i' => 'color: {{VALUE}};',
							],
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'type' 		=> Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item .ova-media .icon' => 'background-color: {{VALUE}};',
							],
						]
					);
		        ...
		        $this->start_controls_tab(
		            ...
		            [
		             ...
		             $this->add_control(
						...
						[
							...
							'type' 		=> Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item:hover .ova-media .icon i' => 'color: {{VALUE}};',
							],
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'type' 		=> Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item:hover .ova-media .icon-mask' => 'background-color: {{VALUE}};',
								'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item-template2 .ova-media .icon:hover' => 'background-color: {{VALUE}};',
							],
						]
					);
	        ...
	        $this->add_responsive_control(
	            ...
	            [
	                ...
	                'size_units' 	=> [ 'px', '%', 'em' ],
	                'selectors' 	=> [
	                    '{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .item .ova-media .icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	                ],
	            ]
	        );
		...
		$this->start_controls_section(
            ...
            $this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .owl-dots' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
				...
				$this->start_controls_tab(
		            ...
		            $this->add_control(
						...
						[
							...
							'type' 		=> Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .owl-dots .owl-dot span' => 'background-color: {{VALUE}}',
							],
						]
					);
					...
					$this->add_responsive_control(
						...
						[
							...
							'size_units' 	=> [ 'px' ],
							'selectors' 	=> [
								'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .owl-dots .owl-dot span' => 'width: {{SIZE}}{{UNIT}};',
							],
						]
					);
					...
					$this->add_responsive_control(
						...
						[
							...
							'size_units' 	=> [ 'px' ],
							'selectors' 	=> [
								'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .owl-dots .owl-dot span' => 'height: {{SIZE}}{{UNIT}};',
							],
						]
					);
					...
					$this->add_control(
			            ...
			            [
			                ...
			                'size_units' 	=> [ 'px', '%' ],
			                'selectors' 	=> [
			                    '{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .owl-dots .owl-dot span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			                ],
			            ]
			        );
		        ...
		        $this->start_controls_tab(
		            ...
		            [
		             ...
		             $this->add_control(
						...
						[
							...
							'type' 		=> Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .owl-dots .owl-dot.active span' => 'background-color: {{VALUE}}',
							],
						]
					);
					...
					$this->add_responsive_control(
						...
						[
							...
							'size_units' 	=> [ 'px' ],
							'selectors' 	=> [
								'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .owl-dots .owl-dot.active span' => 'width: {{SIZE}}{{UNIT}};',
							],
						]
					);
					...
					$this->add_responsive_control(
						...
						[
							...
							'size_units' 	=> [ 'px' ],
							'selectors' 	=> [
								'{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .owl-dots .owl-dot.active span' => 'height: {{SIZE}}{{UNIT}};',
							],
						]
					);
					...
					$this->add_control(
			            ...
			            [
			                ...
			                'size_units' 	=> [ 'px', '%' ],
			                'selectors' 	=> [
			                    '{{WRAPPER}} .ova-project-slider-2 .slide-project-2 .owl-dots .owl-dot.active span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			                ],
			            ]
			        );
	...
	protected function render() {
		...
		$template = apply_filters( 'elementor_ova_project_slider2', 'elementor/ova_project_slider2.php' );
