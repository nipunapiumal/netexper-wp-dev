...
class Infetech_Elementor_Menu_Footer extends Widget_Base {

	
	public function get_name() {
		return 'infetech_elementor_menu_footer';
	}

	
	public function get_title() {
		return esc_html__( 'Menu Footer', 'infetech' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_menu',
			[
				'label' => esc_html__( 'Menu', 'infetech' ),
			]
		);
...
$widgets_manager->register( new Infetech_Elementor_Menu_Footer() );