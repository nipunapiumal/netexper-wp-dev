 ...
 * @since 1.0.0
 */
class Infetech_Elementor_Tabs extends Widget_Tabs {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_tabs',
            [
                'label' => esc_html__( 'Tabs', 'infetech' ),
            ]
        );
        ...
        $repeater->add_control(
            'tab_icon_image',
            [
                'label' => esc_html__( 'Icon/Image', 'infetech' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'none' => [
                        'title' => esc_html__( 'None', 'infetech' ),
                        'icon' => 'eicon-ban',
                    ],
                    'icon' => [
                        'title' => esc_html__( 'Icon', 'infetech' ),
                        'icon' => 'eicon-caret-right',
                    ],
                    'image' => [
                        'title' => esc_html__( 'Image', 'infetech' ),
                        'icon' => 'eicon-image',
                    ],
                ],
                'default'   => 'none',
        ...
        $repeater->add_control(
            'ova_icon',
            [
                'label'     => esc_html__( 'Choose Icon', 'infetech' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Tab Title', 'infetech' ),
                'placeholder' => esc_html__( 'Tab Title', 'infetech' ),
                'label_block' => true,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Tab Content', 'infetech' ),
                'placeholder' => esc_html__( 'Tab Content', 'infetech' ),
        ...
        $this->add_control(
            'tabs',
            [
                'label' => esc_html__( 'Tabs Items', 'infetech' ),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'tab_title' => esc_html__( 'Tab #1', 'infetech' ),
                        'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'infetech' ),
                    ],
                    [
                        'tab_title' => esc_html__( 'Tab #2', 'infetech' ),
                        'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'infetech' ),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'horizontal',
                'options' => [
                    'horizontal' => esc_html__( 'Horizontal', 'infetech' ),
                    'vertical' => esc_html__( 'Vertical', 'infetech' ),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    '' => [
                        'title' => esc_html__( 'Start', 'infetech' ),
        ...
        $this->add_control(
            'navigation_width',
            [
                'label' => esc_html__( 'Navigation Width', 'infetech' ),
        ...
        $this->add_control(
            'border_color',
            [
                'label' => esc_html__( 'Border Color', 'infetech' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Navigation', 'infetech' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'toggle' => true,
                    'selectors' => [
                        '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-wrapper > .elementor-tab-desktop-title' => 'text-align: {{VALUE}}',
                    ],
                    'condition' => [
            ...
            $this->start_controls_tabs(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Color Mobile', 'infetech' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title' => 'color: {{VALUE}}',
                            ],
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Background Mobile', 'infetech' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title' => 'background-color: {{VALUE}}',
                            ],
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Border Color Active', 'infetech' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius (first-child)', 'infetech' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius (last-child)', 'infetech' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
...
$widgets_manager->register(new Infetech_Elementor_Tabs());