 ...
 * @since 1.0.0
 */
class Infetech_Elementor_Toggle extends Widget_Toggle {
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_toggle',
			[
				'label' => esc_html__( 'Toggle', 'infetech' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Toggle Title', 'infetech' ),
				'label_block' => true,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Toggle Content', 'infetech' ),
				'show_label' => false,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Toggle Items', 'infetech' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => esc_html__( 'Toggle #1', 'infetech' ),
					...
					[
						'tab_title' => esc_html__( 'Toggle #2', 'infetech' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'infetech' ),
					],
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active Icon', 'infetech' ),
				'type' => Controls_Manager::ICONS,
		...
		$this->add_control(
			'faq_schema',
			[
				'label' => esc_html__( 'FAQ Schema', 'infetech' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius Active', 'infetech' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
            ...
            $this->add_control(
				'show_before_title',
				[
					'label' 	=> esc_html__( 'Show Before Title', 'infetech' ),
            ...
            $this->add_control(
                'ova_before_title',
                [
                    'label'     => esc_html__( 'Before Title Style', 'infetech' ),
		...
		$this->add_control(
			'icon_hover_color',
			[
				'label' => esc_html__( 'Hover Color', 'infetech' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'icon_active_color',
			[
				'label' => esc_html__( 'Active Color', 'infetech' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'ova_before_icon',
			[
				'label' 	=> esc_html__( 'Before Icon', 'infetech' ),
	        ...
	        $this->add_control(
				'show_boxes_icon',
				[
					'label' 	=> esc_html__( 'Show Border Icon', 'infetech' ),
					'type' 		=> \Elementor\Controls_Manager::SWITCHER,
					'label_on' 	=> esc_html__( 'Show', 'infetech' ),
					'label_off' => esc_html__( 'Hide', 'infetech' ),
					'default' 	=> 'no',
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Margin (p, h1... h6)', 'infetech' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
...
$widgets_manager->register(new Infetech_Elementor_Toggle());
